...
public class LightCircleTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (world instanceof ServerLevel _level)
			_level.sendParticles(ParticleTypes.SMOKE, (x + Math.sin((ParticlepresetsModVariables.WorldVariables.get(world).timer * Math.PI) / 180)), (y + 1),
